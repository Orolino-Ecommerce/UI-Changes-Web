              ...
              >
                <div className="banner banner-poster">
                  ...
                  <div className="banner-content banner-content-right">
                    <h3 className="banner-subtitle">
                      <ALink href="#">Amazing Value</ALink>
                    </h3>
                    <h2 className="banner-title">
                      <ALink href="#">High Performance 4K TVs</ALink>
                    </h2>
                ...
                <div className="banner banner-poster">
                  ...
                  <div className="banner-content">
                    <h3 className="banner-subtitle">
                      <ALink href="#">Weekend Deal</ALink>
                    </h3>
                    <h2 className="banner-title">
                      <ALink href="#">Apple & Accessories</ALink>
                    </h2>
                    <ALink href="/shop/sidebar/list" className="banner-link">
                      Shop Now <i className="icon-long-arrow-right"></i>
                    </ALink>
