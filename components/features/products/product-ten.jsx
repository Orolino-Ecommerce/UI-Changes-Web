...
function ProductTen(props) {
  ...
  console.log("productten===", product);
  return (
    <div className="product">
      <figure className="product-media">
        ...
        <ALink href={`/product/default/${product.product_id}`}>
          <LazyLoadImage
            alt="product"
          ...
          {product.product_galleries.length >= 2 ? (
            <LazyLoadImage
              alt="product"
              src={product.product_galleries[1].gallery_image}
              threshold={500}
              effect="black and white"
      ...
      <div className="product-body product-action-inner">
        ...
        {product?.product_variant_prices
          ...
          .map((item, index) => (
            <ALink
              href={`/product/default/${product?.product_id}`}
